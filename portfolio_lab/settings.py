...
SECRET_KEY = '^01ow3nttmj(eumi-voeq8kcddmhjcu@668cpc5x7di8tmg24('
...
INSTALLED_APPS = [
    ...
    'oddam_w_dobre_rece.apps.OddamWDobreReceConfig',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'oddam_w_dobre_rece/../oddam_w_dobre_rece/templates')]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
